...
func (r *categoryResolver) Courses(ctx context.Context, obj *model.Category) ([]*model.Course, error) {
	courses, err := r.CourseDB.FindAllFromCategory(obj.ID)
	if err != nil {
		return nil, err
	}

	courseModels := make([]*model.Course, 0, len(courses))
...
func (r *courseResolver) Category(ctx context.Context, obj *model.Course) (*model.Category, error) {
	category, err := r.CourseDB.FindCategory(obj.ID)
	if err != nil {
		return nil, err
	}
...
func (r *mutationResolver) CreateCourse(ctx context.Context, input model.NewCourse) (*model.Course, error) {
	course, err := r.CourseDB.Create(input.CategoryID, input.Name, *input.Description)
	if err != nil {
		return nil, err
	}
...
func (r *queryResolver) Categories(ctx context.Context) ([]*model.Category, error) {
	...
	categoryModels := make([]*model.Category, 0, len(categories))
